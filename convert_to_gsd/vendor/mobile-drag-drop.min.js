...
!(function (t, i) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(['exports'], i)
          : i((t.MobileDragDrop = t.MobileDragDrop || {}));
})(this, function (t) {
    'use strict';
    var c = 'dnd-poly-',
    ...
    function h(t, i, s) {
        (void 0 === s && (s = !0), document.addEventListener(t, i, !!e && { passive: s }));
    }
    function n(t, i) {
    ...
    function v(t, i, s, n, h) {
        ...
        (n && ((e += n.x), (i += n.y)),
            (h = void 0 === h || h) &&
                ((e -= parseInt(t.offsetWidth, 10) / 2), (i -= parseInt(t.offsetHeight, 10) / 2)));
    ...
    var p =
        (Object.defineProperty(g.prototype, 'dropEffect', {
            get: function () {
                return this.t;
            },
            set: function (t) {
        ...
        (g.prototype.clearData = function (t) {
            2 === this.i.mode &&
                (t && this.i.data[t]
                    ? (delete this.i.data[t],
                      -1 < (t = this.i.types.indexOf(t)) && this.i.types.splice(t, 1))
                    : ((this.i.data = {}), (this.i.types = [])));
        }),
    ...
    function y(u, t, a, i, s, n, c) {
        ...
        ((s = (function (t, i, s, n, h, e, r) {
            ...
            var o = a.changedTouches[0],
                n = new Event(u, { bubbles: !0, cancelable: n });
            ((n.dataTransfer = e),
                (n.relatedTarget = r),
                (n.screenX = o.screenX),
                (n.screenY = o.screenY),
        ...
        })(t, 0, 0, (n = void 0 === n || n), document.defaultView, s, c)),
            (s = !t.dispatchEvent(s)));
        return ((i.mode = 0), s);
    }
    function b(t, i) {
    ...
    var w =
        ((x.prototype.o = function () {
            ...
            ((this.u = 1),
                (this.l = f[0]),
                (this.v = { data: {}, effectAllowed: void 0, mode: 3, types: [] }),
                (this.p = { x: null, y: null }),
                (this.g = { x: null, y: null }));
            var h = this.m;
            if (
                ((this.I = new p(this.v, function (t, i, s) {
                    ((h = t),
                        ('number' != typeof i && 'number' != typeof s) ||
                            (n.j = { x: i || 0, y: s || 0 }));
                })),
                (this.v.mode = 2),
                (this.I.dropEffect = f[0]),
                y('dragstart', this.m, this.k, this.v, this.I))
            )
                return ((this.u = 3), this.C(), !1);
            ...
            return (
                (this.A =
                    ...
                    d.map(function (t) {
                        ...
                        return t && 'none' !== t
                            ? t.replace(/translate\(\D*\d+[^,]*,\D*\d+[^,]*\)\s*/g, '')
                            : '';
                    }))),
                ...
                s.classList.add('dnd-poly-drag-image'),
                s.classList.add('dnd-poly-icon'),
                (this.O = s),
                this.j ||
                    (this.S.dragImageOffset
                        ? (this.j = { x: this.S.dragImageOffset.x, y: this.S.dragImageOffset.y })
                        : this.S.dragImageCenterOnTouch
                ...
                (this.D = window.setInterval(function () {
                    n.F || ((n.F = !0), n.N(), (n.F = !1));
                }, this.S.iterationInterval)),
                !0
            );
        }),
        (x.prototype.C = function () {
            (this.D && (clearInterval(this.D), (this.D = null)),
                n('touchmove', this.P),
                n('touchend', this.T),
                n('touchcancel', this.T),
                this.O && (this.O.parentNode.removeChild(this.O), (this.O = null)),
                this.L(this.S, this.k, this.u));
        }),
        (x.prototype._ = function (t) {
            ...
            if (!1 !== r(t, this.M.identifier)) {
                if (((this.k = t), 0 === this.u)) {
                    ...
                    return i
                        ? void (!0 === this.o() && (this.H.preventDefault(), t.preventDefault()))
                        : void this.C();
                }
                if (
                    (t.preventDefault(),
                    a('client', t, this.p),
                    a('page', t, this.g),
                    this.S.dragImageTranslateOverride)
                )
                    try {
                        var n = !1;
                        if (
                            (this.S.dragImageTranslateOverride(
                                ...
                                function (t, i) {
                                    s.O &&
                                        ...
                                        (s.g.x += t),
                                        (s.g.y += i),
                                        v(s.O, s.g, s.A, s.j, s.S.dragImageCenterOnTouch));
                                }
                            ),
                            n)
                        )
        ...
        (x.prototype.X = function (t) {
            if (!1 !== r(t, this.M.identifier)) {
                ...
                0 !== this.u
                    ? (t.preventDefault(), (this.u = 'touchcancel' === t.type ? 3 : 2))
                    : this.C();
            }
        }),
        (x.prototype.N = function () {
            ...
            if ((o && (this.l = f[0]), o || 2 === this.u || 3 === this.u))
                return this.Y(this.u)
                    ? ((e = this.m),
                      ...
                      void ('hidden' !== (r = getComputedStyle(e)).visibility &&
                      'none' !== r.display
                          ? (s.classList.add('dnd-poly-snapback'),
                            (h = getComputedStyle(s)),
                            (o = parseFloat(h.transitionDuration)),
                            isNaN(o) || 0 === o
                                ? a()
                                : (((e = { x: (u = e.getBoundingClientRect()).left, y: u.top }).x +=
                                      document.body.scrollLeft ||
                                      document.documentElement.scrollLeft),
                                  (e.y +=
                                      document.body.scrollTop ||
                                      document.documentElement.scrollTop),
                                  (e.x -= parseInt(r.marginLeft, 10)),
                                  (e.y -= parseInt(r.marginTop, 10)),
                                  (u = parseFloat(h.transitionDelay)),
                                  (u = Math.round(1e3 * (o + u))),
                                  v(s, e, n, void 0, !1),
                                  setTimeout(a, u)))
                          : a()))
                    : void this.q();
            ...
            (u !== this.V &&
                ...
                null !== this.B &&
                    ((this.v.mode = 3),
                    (this.I.dropEffect = f[0]),
                    y('dragexit', this.B, this.k, this.v, this.I, !1)),
                null === this.V
                    ? (this.B = this.V)
                    : ((this.v.mode = 3),
                      (this.I.dropEffect = m(this.v.effectAllowed, this.m)),
                      y('dragenter', this.V, this.k, this.v, this.I)
                          ? ((this.B = this.V),
                            (this.l = b(this.I.effectAllowed, this.I.dropEffect)))
                          : this.V !== document.body && (this.B = document.body))),
                a !== this.B &&
                    l(a) &&
                    ((this.v.mode = 3),
                    (this.I.dropEffect = f[0]),
                    y('dragleave', a, this.k, this.v, this.I, !1, this.B)),
                l(this.B) &&
                    ((this.v.mode = 3),
                    (this.I.dropEffect = m(this.v.effectAllowed, this.m)),
                    !1 === y('dragover', this.B, this.k, this.v, this.I)
                        ? (this.l = f[0])
                        : (this.l = b(this.I.effectAllowed, this.I.dropEffect))),
                i !== this.l && this.O.classList.remove(c + i));
            i = c + this.l;
            ...
            return (
                t
                    ? l(this.B) &&
                      ((this.v.mode = 3),
                      (this.I.dropEffect = f[0]),
                      y('dragleave', this.B, this.k, this.v, this.I, !1))
                    : l(this.B) &&
                      ((this.v.mode = 1),
                      (this.I.dropEffect = this.l),
                      !0 === y('drop', this.B, this.k, this.v, this.I)
                          ? (this.l = this.I.dropEffect)
                          : (this.l = f[0])),
                t
            );
        }),
        (x.prototype.q = function () {
            ((this.v.mode = 3),
                (this.I.dropEffect = this.l),
                y('dragend', this.m, this.k, this.v, this.I, !1),
                (this.u = 2),
                this.C());
        }),
        x);
    function x(t, i, s, n) {
        ((this.H = t),
            ...
            (this.B = null),
            (this.k = t),
            (this.M = t.changedTouches[0]),
            (this.P = this._.bind(this)),
            (this.T = this.X.bind(this)),
            h('touchmove', this.P, !1),
            h('touchend', this.T, !1),
            h('touchcancel', this.T, !1));
    }
    var I,
        j = {
                        ...
                        if (1 === i.nodeType) {
                            ...
                            ((s.style.pointerEvents = 'none'),
                                ...
                                'CANVAS' === s.nodeName &&
                                    ...
                                    (h = (h = i)
                                        .getContext('2d')
                                        .getImageData(0, 0, h.width, h.height)),
                                    n.getContext('2d').putImageData(h, 0, 0)));
                        }
                        if (i.hasChildNodes())
                            for (r = 0; r < i.childNodes.length; r++)
                                t(i.childNodes[r], s.childNodes[r]);
                        !(function t(i) {
                            if (
                                (i instanceof HTMLElement && (i.style.pointerEvents = 'none'),
                                i.children && i.children.length)
                            )
                                for (var s = 0; s < i.children.length; s++) t(i.children[s]);
                            if (i.shadowRoot && i.shadowRoot.children.length)
                                for (s = 0; s < i.shadowRoot.children.length; s++)
                                    t(i.shadowRoot.children[s]);
                        })(s);
                    })(t, i),
                    i
                );
    ...
    function C(t) {
        function i(t) {
            (h.off(),
                ...
                s &&
                    s.dispatchEvent(
                        new CustomEvent('dnd-poly-dragstart-cancel', {
                            bubbles: !0,
                            cancelable: !0
                        })
                    ),
        ...
        s &&
            s.dispatchEvent(
                new CustomEvent('dnd-poly-dragstart-pending', { bubbles: !0, cancelable: !0 })
            );
    ...
    function S(t, i, s) {
        if (0 === s && t.defaultActionOverride)
            try {
    ...
    ((t.polyfill = function (i) {
        if (
            ...
            t =
                ((t = !!window.chrome || /chrome/i.test(navigator.userAgent)),
                {
        ...
        (t.supportsPassiveEventListener = i),
