...
var initSqlJs = function (moduleConfig) {
    ...
    initSqlJsPromise = new Promise(function (resolveModule, reject) {
        ...
        k.onRuntimeInitialized = function () {
            ...
            var g = y(4),
                h = k.cwrap,
                q = h('sqlite3_open', 'number', ['string', 'number']),
                w = h('sqlite3_close_v2', 'number', ['number']),
                t = h('sqlite3_exec', 'number', ['number', 'string', 'number', 'number', 'number']),
                x = h('sqlite3_changes', 'number', ['number']),
                ...
                pb = h('sqlite3_sql', 'string', ['number']),
                nc = h('sqlite3_normalized_sql', 'string', ['number']),
                ...
                pc = h('sqlite3_bind_double', 'number', ['number', 'number', 'number']),
                qc = h('sqlite3_bind_int', 'number', ['number', 'number', 'number']),
                rc = h('sqlite3_bind_parameter_index', 'number', ['number', 'string']),
                sc = h('sqlite3_step', 'number', ['number']),
                tc = h('sqlite3_errmsg', 'string', ['number']),
                uc = h('sqlite3_column_count', 'number', ['number']),
                vc = h('sqlite3_data_count', 'number', ['number']),
                wc = h('sqlite3_column_double', 'number', ['number', 'number']),
                sb = h('sqlite3_column_text', 'string', ['number', 'number']),
                xc = h('sqlite3_column_blob', 'number', ['number', 'number']),
                yc = h('sqlite3_column_bytes', 'number', ['number', 'number']),
                zc = h('sqlite3_column_type', 'number', ['number', 'number']),
                Ac = h('sqlite3_column_name', 'string', ['number', 'number']),
                Bc = h('sqlite3_reset', 'number', ['number']),
                Cc = h('sqlite3_clear_bindings', 'number', ['number']),
                Dc = h('sqlite3_finalize', 'number', ['number']),
                tb = h(
                    'sqlite3_create_function_v2',
                    'number',
                    'number string number number number number number number number'.split(' ')
                ),
                hc = h('sqlite3_value_type', 'number', ['number']),
                kc = h('sqlite3_value_bytes', 'number', ['number']),
                jc = h('sqlite3_value_text', 'string', ['number']),
                lc = h('sqlite3_value_blob', 'number', ['number']),
                ic = h('sqlite3_value_double', 'number', ['number']),
                ec = h('sqlite3_result_double', '', ['number', 'number']),
                lb = h('sqlite3_result_null', '', ['number']),
                fc = h('sqlite3_result_text', '', ['number', 'string', 'number', 'number']),
                gc = h('sqlite3_result_blob', '', ['number', 'number', 'number', 'number']),
                dc = h('sqlite3_result_int', '', ['number', 'number']),
                sa = h('sqlite3_result_error', '', ['number', 'string', 'number']),
                ub = h('sqlite3_aggregate_context', 'number', ['number', 'number']),
                ob = h('RegisterExtensionFunctions', 'number', ['number']),
                    ...
                    for (f = []; 0 !== r(v, 'i8'); ) {
                        ...
                        if (0 !== I) {
                            ...
                            for (null != l && p.bind(l); p.step(); )
                                (null === H &&
                                    ((H = { columns: p.getColumnNames(), values: [] }), f.push(H)),
                                    H.values.push(p.get(null, n)));
                            p.free();
                        }
                    }
                    return f;
            ...
            e.prototype.create_function = function (f, l) {
                Object.prototype.hasOwnProperty.call(this.Sa, f) &&
                    (A(this.Sa[f]), delete this.Sa[f]);
        ...
        var Da = console.log.bind(console),
            B = console.error.bind(console),
            Ea,
            Fa = !1,
            Ga,
            Ca = (a) => a.startsWith('file://'),
            m,
            C,
            Ha,
            E,
        ...
        async function Ra(a) {
            ...
            if (!Ea && !Ca(b) && !ca)
                try {
                    ...
                    (B(`wasm streaming compile failed: ${d}`),
        ...
        var Za = new TextDecoder(),
            ...
            z = (a, b, c) => (a ? Za.decode(C.subarray(a, $a(C, a, b, c))) : ''),
            ab = (a, b) => {
            ...
            O = {
                ...
                createNode(a, b, c, d) {
                    ...
                    O.Wa ||
                        (O.Wa = {
                            ...
                            vb: { node: { Ta: O.La.Ta, Ua: O.La.Ua }, stream: yb }
                        });
                    c = zb(a, b, c, d);
                    P(c.mode)
                        ...
                        : 32768 === (c.mode & 61440)
                          ...
                          : 40960 === (c.mode & 61440)
                            ...
                            : 8192 === (c.mode & 61440) &&
                              ((c.La = O.Wa.vb.node), (c.Ma = O.Wa.vb.stream));
                ...
                Ma: {
                    ...
                    write(a, b, c, d, e, g) {
                        ...
                        h >= g ||
                            ((g = Math.max(g, (h * (1048576 > h ? 2 : 1.125)) >>> 0)),
                            0 != h && (g = Math.max(g, 256)),
                            (h = a.Na),
                            (a.Na = new Uint8Array(g)),
                            0 < a.Ra && a.Na.set(h.subarray(0, a.Ra), 0));
        ...
        function ma(a, b, c = 438) {
            ...
            b & 512 &&
                !g &&
                ((e = d), (e = 'string' == typeof e ? S(e, { $a: !0 }).node : e), ac(null, e, 0));
            b &= -131713;
            e = Rb({
                node: d,
                path: ha(d),
        ...
        var Ec = void 0,
            ...
            Hc = 0,
            Ic = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
            Jc = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
            Kc = {},
            Lc = (a) => {
                Ga = a;
                Ya || 0 < Hc || (k.onExit?.(a), (Fa = !0));
                xa(a, new Sa(a));
            },
            Mc = (a) => {
                if (!Fa)
            ...
            Uc = { i: 127, p: 127, j: 126, f: 125, d: 124, e: 111 },
            Vc = (a) => Tc(Array.from(a, (b) => Uc[b])),
            va = (a, b) => {
                if (!Rc) {
                    Rc = new WeakMap();
                    var c = Z.length;
                ...
                try {
                    ...
                    b = Uint8Array.of(
                        ...
                        0,
                        1,
                        ...Tc([1, 96, ...Vc(b.slice(1)), ...Vc('v' === b[0] ? '' : b[0])]),
                        2,
                        7,
                        1,
                        1,
        ...
        var da,
            ...
            Xc = {
                ...
                h: function (a) {
                    try {
                        var b = T(a);
                        Tb(b, b.node, { timestamp: Date.now(), Fb: !1 });
                        return 0;
                    } catch (c) {
                        if ('undefined' == typeof X || 'ErrnoError' !== c.name) throw c;
                        return -c.Pa;
                ...
                q: function (a, b, c) {
                    try {
                        ...
                        var d = Date.now(),
                            ...
                            g;
                        if (c) {
                            var h = F[c >> 2] + 4294967296 * E[(c + 4) >> 2],
                                q = E[(c + 8) >> 2];
                            1073741823 == q
                                ? (e = d)
                                : 1073741822 == q
                ...
                A: function (a, b) {
                    ...
                    var c = a.getFullYear();
                    E[(b + 28) >> 2] =
                        ((0 !== c % 4 || (0 === c % 100 && 0 !== c % 400) ? Jc : Ic)[a.getMonth()] +
                            a.getDate() -
                            1) |
                        0;
